...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'myhalo@.onmicrosoft.com',
  ...
  email: 'mailto:mellodyroo@gmail.com',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/clement777-lim/onedrive-vercel-index',
    },
  ],
